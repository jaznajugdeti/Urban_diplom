...
def matplotlib_iris_hist(f1, f2, fontsize, bins ):
    plt.figure(figsize=(f1, f2))
    plt.hist(data['sepal length (cm)'], bins=bins, alpha=0.7, label='Sepal Length', color='blue')
    plt.hist(data['petal length (cm)'], bins=bins, alpha=0.7, label='Petal Length', color='orange')
    plt.title("Distribution of Sepal and Petal Lengths", fontsize=fontsize+4)
    ...
    plt.tight_layout()
    plt.show()
matplotlib_iris_hist(10, 6, 12, 15)
...
def matplotlib_iris_scatter(f1, f2, fontsize, alpha, title):
    ...
    plt.tight_layout()
    plt.show()
matplotlib_iris_scatter(10, 6, 12, 0.7, "Species")
...
def matplotlib_iris_pie(f1, f2, fontsize, startangle):
    species_counts = data['species_name'].value_counts()
    plt.figure(figsize=(f1, f2))
    plt.pie(species_counts, labels=species_counts.index, autopct='%1.1f%%', startangle=startangle,
            colors=['red', 'green', 'blue'])
    plt.title("Distribution of Iris Species", fontsize=fontsize)
    plt.show()
matplotlib_iris_pie(8, 8, 16, 90)